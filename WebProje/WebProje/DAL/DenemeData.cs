    ...
    public class DenemeData:System.Data.Entity.DropCreateDatabaseIfModelChanges<VeriContext>
    {
        protected override void Seed(VeriContext context)
        {
            ...
            var Haberler = new List<Haber>
            {
                ...
                new Haber {AdminID=2,Icerik="Hakan Eryücelin Haberi",Foto="https://img.fanatik.com.tr/img/78/700x0/5c1f41b866a97ce31314d2f8",Kategori=Kategoriler.Basketbol,Takim=Takim.Fenerbahce,HaberTarihi=DateTime.Parse("2018-11-28"),Onay=true,Baslik="Baslik4",OkunmaSayisi=121},
                ...
                new Haber {AdminID=2,Icerik="Hakan Eryücelin Haberi",Foto="https://img.fanatik.com.tr/img/78/700x0/5c1f41b866a97ce31314d2f8",Kategori=Kategoriler.Futbol,Takim=Takim.Fenerbahce,HaberTarihi=DateTime.Parse("2018-11-28"),Onay=true,Baslik="Baslik2",OkunmaSayisi=22},
                new Haber {AdminID=2,Icerik="Hakan Eryücelin Haberi",Foto="https://img.fanatik.com.tr/img/78/700x0/5c01479866a97cdcd4229c47",Kategori=Kategoriler.Futbol,Takim=Takim.Fenerbahce,HaberTarihi=DateTime.Parse("2018-11-28"),Onay=true,Baslik="Baslik3",OkunmaSayisi=22},
                new Haber {AdminID=2,Icerik="Hakan Eryücelin Haberi",Foto="https://img.fanatik.com.tr/img/78/700x0/5c1f77ddae298b05bd2d9c78",Kategori=Kategoriler.Basketbol,Takim=Takim.Fenerbahce,HaberTarihi=DateTime.Parse("2018-11-28"),Onay=true,Baslik="Baslik4",OkunmaSayisi=22},
                new Haber {AdminID=2,Icerik="Hakan Eryücelin Haberi",Foto="https://img.fanatik.com.tr/img/78/700x0/5c01479866a97cdcd4229c47",Kategori=Kategoriler.Basketbol,Takim=Takim.Fenerbahce,HaberTarihi=DateTime.Parse("2018-11-28"),Onay=true,Baslik="Baslik5",OkunmaSayisi=22},
