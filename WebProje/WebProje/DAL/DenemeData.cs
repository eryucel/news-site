    ...
    public class DenemeData:System.Data.Entity.DropCreateDatabaseIfModelChanges<VeriContext>
    {
        protected override void Seed(VeriContext context)
        {
            ...
            var Haberler = new List<Haber>
            {
                ...
                new Haber {AdminID=2,Icerik="Hakan Eryücelin Haberi",Foto="https://img.fanatik.com.tr/img/78/700x0/5c01479866a97cdcd4229c47",Kategori=Kategoriler.Voleybol,Takim=Takim.Fenerbahce,HaberTarihi=DateTime.Parse("2018-11-28"),Onay=true,Baslik="Baslik6",OkunmaSayisi=121},
                new Haber {AdminID=2,Icerik="Hakan Eryücelin Haberi",Foto="https://img.fanatik.com.tr/img/78/700x0/5c01479866a97cdcd4229c47",Kategori=Kategoriler.Diger,Takim=Takim.Fenerbahce,HaberTarihi=DateTime.Parse("2018-11-28"),Onay=true,Baslik="Baslik7",OkunmaSayisi=78}
            };
